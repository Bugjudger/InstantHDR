...
def train(cfg_dict: DictConfig):
    # Resolve Hydra's output path before converting to plain dataclasses.
    cfg_dict.train.output_path = HydraConfig.get().runtime.output_dir
    ...
    if cfg_dict.wandb.mode != "disabled":
        ...
        logger = LocalLogger(output_dir / "images")
    ...
    if checkpoint_path:
        # Lightning restores the complete model and optimizer when resuming.
